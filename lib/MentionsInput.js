...
module.exports = React.createClass({
  ...
  renderInput: function renderInput(props) {
    ...
    if (this.props.singleLine) {
      ...
      return React.createElement('input', _extends({ type: 'text' }, props, { ref: 'input', style: style, className: props.inputClassName }));
    }
    ...
    return React.createElement('textarea', _extends({}, props, { ref: 'input', style: style, className: props.inputClassName }));
  },
